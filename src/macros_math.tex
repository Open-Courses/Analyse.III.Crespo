...
%		#3 : end indice
%		#4 : set
\newcommand{\GSprodSet}[4]{$\prod\limits_{#1 = #2}^{#3} #4_{#1}$}
...
%		#3 : end indice
%		#4 : element
\newcommand{\GSsum}[4]{$\sum\limits_{#1 = #2}^{#3}$ #4}
...
\newcommand{\GSultraproduct}[4]{$\prod\limits_{#1 \in #2}^{#3}#4_{#1}$}
...
%	3 : ultrafilter
%	4 : model
\newcommand{\GSultrapower}[4]{$\prod\limits_{#1 \in #2}^{#3}#4$}
