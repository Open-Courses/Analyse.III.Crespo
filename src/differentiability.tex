...
\begin{definition} [Algèbre normée]
...
\begin{definition} [Application produit]
...
\begin{proposition} [Règle de Leibniz]
	\label{proposition:leibniz_rule}
...
Donnons un autre exemple qui nous servira dans les prochains chapitres

\begin{proposition}
	\label{proposition:composition_linear_application_is_bounded_bilinear}
	Soient $E, F, G$ des espaces vectoriels normés.
	Soit
	\begin{align}
		B : \GScontinueHomo{F}{G} \cartprod
		\GScontinueHomo{E}{F} & \rightarrow \GScontinueHomo{E}{G} \\
		(f, g) & \rightarrow f \circ g
	\end{align}
	l'application de composition de fonction.

	Alors $B$ est bilinéaire continue, ie $B \in
	\GScontinueHomo[2]{\GScontinueHomo{F}{G},
	\GScontinueHomo{E}{F}}{\GScontinueHomo{E}{G}}$.
\end{proposition}
