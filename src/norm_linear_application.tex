...
\label{definition_serie_normal_convergence}
	...
	\GSsum{n}{0}{\infty}{$||u_{n}||_{E}$} $< \infty$.
\end{definition}
...
\label{proposition_normal_imply_convergence}
	...
	$||$\GSsum{n}{0}{\infty}{$u_{n}$}$|| \leq $
	\GSsum{u}{0}{\infty}{$||u_{n}||$}.
\end{proposition}
...
\begin{proof}
	Comme $E$ est de Banach, alors \GScontinueEndo{E} l'est aussi. Comme $||u||
	< 1$, on a que la série \GSsum{n}{0}{\infty}{$||u^{n}||$} $\leq$
	\GSsum{n}{0}{\infty}{$||u||^{n}$} converge. Donc
	\GSsum{n}{0}{\infty}{$u^{n}$} converge
...
\label{proposition_inverse_identity_u}
	Soit $u \in$ \GScontinueEndo{E} tel que $||u||_{\mathcal{L}_{E}} < 1$. Alors
...
\begin{corollary}
	Soit $u \in$ \GScontinueEndo{E} tel que $||u||_{\mathcal{L}_{E}} < 1$.
...
continue. En effet, \ldots %exemple.
...
\GScontinueEndo{\mathbb{K}}{F} et $\mathbb{K}$.
